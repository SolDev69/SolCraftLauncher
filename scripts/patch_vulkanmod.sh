...
copy_libs() {
  ...
  wget -q https://nightly.link/SolDev69/lwjgl3/workflows/build-android/3.3.1/lwjgl3-android-natives-$1.zip
...
wget -q https://nightly.link/SolDev69/lwjgl3/workflows/build-android/3.3.1/lwjgl3-android-modules.zip
